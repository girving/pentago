...
const char* const style =
  ...
  ".all{width:60em;margin:0 auto;background:#fff;border:1px solid;border-radius:1em;overflow:hidden}"
  "header{text-align:center;background:silver;display:inline-block;width:100%;border-bottom:1px solid}"
  "h2{font-size:1.5em;font-weight:bold;margin:.83em 0}"
  "h3{font-size:1.17em;font-weight:bold;margin:1em 0}"
  ".main{background:#fff;float:left;width:calc(100% - 11em);border-left:11em solid silver}"
  "nav.contents{float:left;width:11em;margin-left:-11em;position:relative}"
  "nav.back{top:0;right:0;width:7em;position:absolute;background:silver}"
  ...
  ".content{width:100%;float:left;margin-right:-100%;border-left:1px solid #000;position:relative}"
  "@media(max-width:62em){.all{width:100%}}"
  "@media(max-width:800px){"
    ".main{width:100%;border-left:none}"
    ".content{margin-right:0}"
    "nav.contents{float:none;width:100%;margin-left:0;background:silver;text-align:center;"
