...
// Low enough that hitting the 3-attempt retry limit (p^3 per block) stays negligible
// across the full test, but high enough that retries are regularly exercised.
block_cache.set_flaky(0.02)
