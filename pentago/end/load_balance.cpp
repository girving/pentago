...
GEODE_DEFINE_TYPE(load_balance_t)
...
void wrap_load_balance() {
  ...
  Class<Self>("load_balance_t")
    .GEODE_FIELD(lines)
    .GEODE_FIELD(line_blocks)
    .GEODE_FIELD(line_nodes)
    .GEODE_FIELD(blocks)
    .GEODE_FIELD(block_nodes)
    .GEODE_FIELD(block_local_ids)
    .GEODE_STR()
    ;
  GEODE_FUNCTION(serial_load_balance)
}
