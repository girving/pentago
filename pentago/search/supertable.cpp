...
GEODE_NEVER_INLINE static void store_error(int depth, const superlookup_t& data, const superinfo_t& info) {
...
void wrap_supertable() {
  GEODE_FUNCTION(init_supertable)
  GEODE_FUNCTION(clear_supertable)
  GEODE_FUNCTION(supertable_bits)
  GEODE_FUNCTION(supertable_test)
}
