...
//
// Provides gcs_download() for reading whole objects and gcs_upload() for writes.
// Authentication uses a service account JSON key file with RS256 JWT signing.
#pragma once
...
// Download a complete GCS object into memory.
