// Generated code for the inner loop of midsolve
...
void save(const string& h) {
  const string note = "// Autogenerated by mid/generate: do not edit directly\n\n";
  ofstream out(h.c_str());
  out << R"(
// Autogenerated by mid/generate: do not edit directly
#pragma once

namespace pentago {

__attribute__((always_inline)) static void
midsolve_inner(const int spots, const int k0, 
...
int main(int argc, char** argv) {
  try {
    ...
    GEODE_ASSERT(endswith(h, "inner.h"));
    save(h);
    return 0;
