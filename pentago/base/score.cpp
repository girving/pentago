...
#ifndef NDEBUG
  const int slow_min_distance = min(SLOW_MIN_DISTANCE(d0,17,3),SLOW_MIN_DISTANCE(d1,17,3),SLOW_MIN_DISTANCE(d2,17,3),SLOW_MIN_DISTANCE(d3,17,3));
...
void wrap_score() {
  ...
  GEODE_FUNCTION(rotated_status)
  GEODE_FUNCTION(arbitrarily_rotated_status)
}
