...
#include <set>
namespace geode {
GEODE_DEFINE_ENUM(time_kind_t,GEODE_EXPORT)
...
void wrap_thread() {
  ...
  GEODE_ENUM(time_kind_t)
  GEODE_ENUM_VALUE(compress_kind)
  GEODE_ENUM_VALUE(decompress_kind)
  GEODE_ENUM_VALUE(snappy_kind)
  GEODE_ENUM_VALUE(unsnappy_kind)
  GEODE_ENUM_VALUE(filter_kind)
  GEODE_ENUM_VALUE(schedule_kind)
  GEODE_ENUM_VALUE(wait_kind)
  GEODE_ENUM_VALUE(mpi_kind)
  GEODE_ENUM_VALUE(partition_kind)
  GEODE_ENUM_VALUE(compute_kind)
  GEODE_ENUM_VALUE(accumulate_kind)
  GEODE_ENUM_VALUE(count_kind)
  GEODE_ENUM_VALUE(meaningless_kind)
  GEODE_ENUM_VALUE(read_kind)
  GEODE_ENUM_VALUE(write_kind)
  GEODE_ENUM_VALUE(write_sections_kind)
  GEODE_ENUM_VALUE(write_counts_kind)
  GEODE_ENUM_VALUE(write_sparse_kind)
  GEODE_ENUM_VALUE(allocate_line_kind)
  GEODE_ENUM_VALUE(request_send_kind)
  GEODE_ENUM_VALUE(response_send_kind)
  GEODE_ENUM_VALUE(response_recv_kind)
  GEODE_ENUM_VALUE(wakeup_kind)
  GEODE_ENUM_VALUE(output_send_kind)
  GEODE_ENUM_VALUE(output_recv_kind)
  GEODE_ENUM_VALUE(compacting_kind)
  GEODE_ENUM_VALUE(master_idle_kind)
  GEODE_ENUM_VALUE(cpu_idle_kind)
  GEODE_ENUM_VALUE(io_idle_kind)
  GEODE_ENUM_VALUE(master_missing_kind)
  GEODE_ENUM_VALUE(cpu_missing_kind)
  GEODE_ENUM_VALUE(io_missing_kind)
  GEODE_ENUM_VALUE(_time_kinds)
