...
void wrap_filter() {
  GEODE_FUNCTION(count_causal_cases)
  GEODE_FUNCTION(count_outer_causal_cases)
  GEODE_FUNCTION(count_rotation_cases)
  GEODE_FUNCTION(count_byte_cases)
  GEODE_FUNCTION(interleave)
  GEODE_FUNCTION(uninterleave)
  GEODE_FUNCTION(arbitrary_causal_filter)
  GEODE_FUNCTION(inverse_arbitrary_causal_filter)
  GEODE_FUNCTION(outer_causal_filter)
  GEODE_FUNCTION(inverse_outer_causal_filter)
  GEODE_FUNCTION(compact)
  GEODE_FUNCTION(uncompact)
  GEODE_FUNCTION(wavelet_transform)
  GEODE_FUNCTION(wavelet_untransform)
}
